...
/// <c>X-Dev-User</c> header (see the YARP transform in Program.cs), which the upstreams' dev handlers accept.
/// </summary>
    ...
    : AuthenticationHandler<AuthenticationSchemeOptions>(options, logger, encoder)
{
    ...
    protected override Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        var groups = configuration.GetSection("Dev:Groups").Get<string[]>() ?? [];
